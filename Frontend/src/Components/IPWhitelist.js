...
const IPWhitelist = (props) => {
  ...
  const handleOnChangeRadioButtons = (value) => {
    if(value === "addIP")
    {
      setTypeOFTask(1);
    }
        ...
        >
            ...
            <div className="select-buttons">
              <div>
                <input
                  ...
                  value="addIP"
                  onChange={()=>{handleOnChangeRadioButtons("addIP")}}
                />&nbsp;&nbsp;
                <label
              ...
              <div>
                <input
                  ...
                  onChange={()=>{handleOnChangeRadioButtons("removeIP")}}
                />&nbsp;&nbsp;
                <label
                  className="form-check-label"
          ...
          >
            ...
            <button
              ...
              onClick={() => {
                props.handleSubmit(IPWhitelist,typeOfTask);
                setIsLoading(true);
              }}
